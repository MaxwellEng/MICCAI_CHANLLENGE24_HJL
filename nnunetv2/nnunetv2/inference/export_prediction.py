...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    if return_probabilities:
        ...
        #predicted_probabilities从FLOAT32变为FLOAT16，并且从numpy array变为torch tensor
        #predicted_probabilities = torch.tensor(predicted_probabilities, dtype=torch.float16) 
        predicted_probabilities = predicted_probabilities.astype(np.float16)
